...
DATABASES = {
    'default': {
        ...
        'NAME': AWD_PATH+'/awd/awd2.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = AWD_PATH+'/site/media/' 
...
STATIC_ROOT = AWD_PATH+'/site/static/'
...
SECRET_KEY = '%oxya@-3temqi2p_dnq*+y)4td46u=5tod+wt@7xhwz*zq$rn1'
